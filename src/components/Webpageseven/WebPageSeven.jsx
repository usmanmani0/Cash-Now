...
const WebPageSeven = () => {
    return (
        ...
        <Row>
        <Col Col={4}>
        <img className="PagesevenImg1" src={pg7img1} alt="PagesevenImg1"></img>
        </Col>
        <Col Col={3}>
        <div>
        <img className="PagesevenImg2" src={pg7img2} alt="PagesevenImg2"></img>
        <img className="PagesevenImg3" src={pg7img3} alt="PagesevenImg3"></img>
        </div>
        </Col>
        <Col Col={3}>
        <div>
        <img className="PagesevenImg4" src={pg7img4} alt="PagesevenImg4"></img>
        <img className="PagesevenImg5" src={pg7img5} alt="PagesevenImg5"></img>
        </div>
        </Col>
        <Col Col={2}>
        <div className="pg7location_div">
        <div>
        <img className="Pagesevenloc" src={pg7LocationIcon} alt="Pagesevenloc"></img>
        </div>
