      ...
      <Container>
        <div className="six-section">
          ...
          <div className="para_six">
            <p className="pagesix_detail">
              We kopen huizen in Vlaanderen in elke conditie, situatie en
              prijsklasse. Ons bedrif koopt de eigendom in de staat waarin het
              zich bevindt. Zoats bouwvallig, verwoond, te renoveren, Een huis
              in slechte staat waarin het zich bevindt. Zoals bouwvallig,
              verwoond, te renoveren, Een huis in slechte staat? wij kunnen
              helpen!
            </p>
          </div>
          ...
          <Row>
            ...
            <Col lg={3}>
              <div>
                ...
                ></img>
                <img
                  className="PagesixImg5"
                  src={pg6img5}
                  alt="PagesixImg5"
                ></img>
              </div>
            </Col>
            <Col lg={3} className="location_div">
              <div className="location_div">
                <div>
                  <img
                    className="Pagesixloc"
                    src={pg6LocationIcon}
                    alt="Pagesixloc"
                  ></img>
                </div>
